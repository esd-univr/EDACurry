...
public:
  ...
  explicit SPECTREParser(antlr4::TokenStream *input);

  SPECTREParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SPECTREParser() override;
